...
function SignUp(){
    ...
    const signUpHandler = async (e) => {
        ...
        if(extension[1] !== 'metro.com'){
          alert('Your email extension sholud be metro.com. eg.name@metro.com');
          return;
        }
        ...
        try {
          const res = await fetch(
            "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyD8X7z6JoGsVZcHd-fZKKM8DQxcXCGaT_k",
            {
              method: "POST",
              body: JSON.stringify({
                email: enteredEmail,
